...
<%--<form method="post" name="form1" action="noticeServlet" onsubmit="javascript: return checkNotice();">--%>
  <%--<table>--%>
    <%--<tr>--%>
      <%--<td>标题:</td>--%>
      <%--<td><input type="text" name="title" size="35" value="<%=notice.getTitle()%>"/></td>--%>
    <%--</tr>--%>
    <%--<tr>--%>
      <%--<td>作者:</td>--%>
      <%--<td><input type="text" name="editor" size="35" value="<%=notice.getEditor()%>"/></td>--%>
    <%--</tr>--%>
    <%--<tr>--%>
      <%--<td>内容:</td>--%>
      <%--<td><textarea name="content" rows="10" cols="30" ><%=notice.getContent()%></textarea></td>--%>
    <%--</tr>--%>
    <%--<tr>--%>
      <%--<td> 类型:</td>--%>
      <%--<td><select name="type">--%>
      <%--<%--%>
      	...
      	<%--if (list!=null){--%>
      		<%--for (Type type: list){--%>
      			<%--if (type.getId()==notice.getType()){--%>
      <%--%>--%>
          			<%--<option  value="<%=type.getId()%>" selected="selected"><%=type.getTypeName() %></option>--%>
      <%--<%		}else{--%>
      <%--%>    --%>
